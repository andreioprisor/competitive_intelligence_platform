...
export const api = {
  async fetchCompanyAnalysis(domain: string): Promise<CompanyAnalysisResponse> {
    const response = await fetch(
      `${API_BASE_URL}/profile_competitors_solution?domain=${encodeURIComponent(
        domain
      )}`
    );
  ...
  async getCompanyProfile(
    domain: string
  ): Promise<{ company_profile: any; cache_hit: boolean }> {
    const response = await fetch(
      `${API_BASE_URL}/company_profile?domain=${encodeURIComponent(domain)}`
    );
  ...
  async getSolutions(domain: string): Promise<any[]> {
    const response = await fetch(
      `${API_BASE_URL}/solutions?domain=${encodeURIComponent(domain)}`
    );
  ...
  async getCompetitors(domain: string): Promise<CompetitorResponse[]> {
    const response = await fetch(
      `${API_BASE_URL}/competitors?domain=${encodeURIComponent(domain)}`
    );
  ...
  async deleteCompetitor(
    ...
    const response = await fetch(
      `${API_BASE_URL}/competitors?domain=${encodeURIComponent(
        domain
  ...
  async recordCategoryObservation(
    domain: string,
    data: CategoryObservationRequest
  ): Promise<CategoryObservationResponse> {
    const response = await fetch(
      `${API_BASE_URL}/category_observed?domain=${encodeURIComponent(domain)}`,
      {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  ): Promise<EnrichCompetitorsResponse> {
